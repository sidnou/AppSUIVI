...
# Police  ou Font 
MON_FONT = font.Font(family='Couriel',size=15,weight="bold") # Police du Text 
MON_FONT_1 = font.Font(family='arial',size=12,weight="bold") # Police du Text
MON_FONT_2 = font.Font(family='arial',size=10,weight="bold") # Police du Text
...
label = Label(cadre2,text='Nombre de Colis:',background="#0072B5",font=MON_FONT_1)
nColis = StringVar()
nColis.set("0")
...
valeurDoublon.set("0")
label2 = Label(cadre3,text='Valeurs en doublon',background="#0072B5", font=MON_FONT_1)
...
bouton1 = Button(fenetre, text='Vérification', command=verif_doublon, bg="#12D292",fg="white", font=MON_FONT,width=20)
bouton1.pack()
# Bouton d'Impression 
bouton2 = Button(fenetre, text='Impression', command=impression, bg='#DFA80B', fg="white", font=MON_FONT,width=20)
bouton2.pack()
# Bouton d'éffacement des valeurs saisis 
bouton3 = Button(fenetre,text='Efface', command=effacerValeur ,bg='red',fg='white',font=MON_FONT,width=20)
bouton3.pack()
